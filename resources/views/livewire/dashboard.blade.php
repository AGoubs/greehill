  <main class="h-full overflow-y-auto">
    ...
    <div class="px-6 grid mx-auto" style="width: 100%;">
      <div class="flex justify-between">
        ...
        <a class="flex items-center justify-between p-4 my-6 w-64 text-sm font-semibold text-purple-100 bg-purple-600 hover:bg-purple-700 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple" href="{{ route('question.add') }}">
            ...
            @foreach ($languages as $language)
              <div class="flex items-top p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 dark:text-gray-200">
                <div>
                  @if ($questions != null)
                    @foreach ($questions as $question)
                      @if ($question->language_id == $language)
                        <div @class([
                            'translated' => $question->translated,
                            'question',
                            'mr-5',
                        ...
                        <div class="flex justify-end">
                          <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-full active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" aria-label="Edit"href="{{ route('question.edit', $question->id) }}" style="color:white">
