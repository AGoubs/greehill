     ...
     <div class="container px-6 mx-auto grid">
       ...
       <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
         <form wire:submit.prevent="addQuestion" action="#" method="POST">
          ...
          <button type="button" class="flex items-center justify-between mb-2 px-2 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-full active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" aria-label="Delete"  onclick="confirm('Delete this question ?') || event.stopImmediatePropagation()" wire:click="deleteQuestion()">
