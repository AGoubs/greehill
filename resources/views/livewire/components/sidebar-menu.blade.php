...
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
  <div class="py-4 text-gray-500 dark:text-gray-400">
    <img aria-hidden="true" class="ml-4 dark:hidden" src="{{ asset('img/greehill-wordmark-dark.png') }}" alt="Logo greehill" width="140">
    <img aria-hidden="true" class="hidden ml-4 dark:block" src="{{ asset('img/greehill-wordmark-light.png') }}" alt="Logo greehill" width="140">
    <ul class="mt-6">
      ...
      @foreach ($languages as $language)
        <li class="relative px-6 py-3">
          <article class="sidebar_feature">
            ...
            <div>
              <label class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" for="sidebar_language_{{ $language->id }}" style="margin-top: -5px;"><span class="fi fi-{{ $language->abbreviation }}" style="width:50px;height: 30px;"></span>{{ $language->name }}</label>
            </div>
          </article>
        </li>
      @endforeach
